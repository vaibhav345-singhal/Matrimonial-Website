		...
		if(!isset($_COOKIE["email"])){
			...
			if(!isset($_SESSION[$email])){
				header("location:login.php");
				    ...
				    $rs=mysqli_query($conn,"select * from inbox where tos='$email'");
...
$rs=mysqli_query($conn,"select count(*) from inbox where tos='$email'");
$total_record=0;
					...
					$rs=mysqli_query($conn,"select * from inbox where tos='$email' LIMIT $offset,$limit");
					while($r=mysqli_fetch_array($rs)){
							$tr = mysqli_query($conn, "select * from users where code='$from_code'");
							if($st = mysqli_fetch_array($tr)){
        ...
        ?>
	                ...
	                <div class="jobs-item with-thumb">
	                   <div class="thumb_top">
				        <div class="thumb"><a href="view_profile.html"><img src="photo/<?=$r["from_code"]?>.jpg" class="img-responsive" alt=""/></a></div>
					    <div class="jobs_right">
							<h6 class="title">Profile Id : <?=$r["from_code"]?></a></h6>
							<ul class="top-btns">
                            ...
                            <ul class="login_details1">
							  <li>Name : <?=$st["first"]?> <?=$st["lname"]?></li>
							</ul>
							<p class="description"><?=$r["message"]?><br></p>
					   ...
					   <div class="thumb_bottom">
					   	  <div class="thumb"><a href="view_profile.php?id=<?=$r["from_code"]?>" class="photo_view">View Profile</a></div>
					   	  <div class="clearfix"> </div>
							 <br>
...
<?php 
	 if($offset!=0){
	  ...
	  ?>
	  <a style="color: maroon" href="view_msg.php?page=<?=($page-1)?>"><button  class="vertical">Previous</button>
	  <?php
		}
	  ?>
	...
	?>
	  ...
	  <a style="color: maroon" href="view_msg.php?page=<?=($page+1)?>"><button  class="vertical">Next</button>
