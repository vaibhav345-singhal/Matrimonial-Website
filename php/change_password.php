		   ...
		   <h2>Profile Id : <?=$r["code"]?></h2>
			...
			<?php
				if(isset($_GET["success"])){
				 echo "<h3 style='color:blue'>Password Changed</h3>";
		        	...
		        	<tbody>
					    ...
					    <tr class="opened">
					     ...
					     <tr class="opened">
							...
							<td class="day_value"><input type="password" name="rp"  class="form-control" required><br></td>
						</tr>
					  
					    <tr class="closed">
							<td class="day_label"></td>
							<td class="day_value closed"><input type="submit" value="Submit"></td>
						</tr>
				    </tbody>
				</table>
				</form>
